...
def source_path(dataset, attack, rate, seed):
    return (
...
def artifact_path(dataset, attack, rate, seed):
    return (
...
def generator_command(dataset, attack, rate, seed, cuda, block_size, output):
    command = [
        sys.executable,
...
def validate_provenance(provenance, dataset, attack, rate, seed):
    expected = {
        "dataset": dataset,
        ...
        for attack in args.attacks:
            for rate in args.rates:
                for seed in args.seeds:
                    source = source_path(dataset, attack, rate, seed)
                    destination = artifact_path(dataset, attack, rate, seed)
