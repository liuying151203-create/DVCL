...
Under a unified ACM protocol, preliminary results show that DVCL improves classification accuracy over our HSeCo reproduction under PRBCD, HetePRBCD, and an FGSM-style structural target attack. Broader comparisons across datasets and external robust heterogeneous graph baselines are reserved for the completed evaluation.
\end{abstract}
